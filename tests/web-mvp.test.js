...
test('mini program mirrors the static entry, cabinet home, and add-rope page', () => {
  ...
  assert.ok(miniWxml.includes('class="login-gate image-login-gate {{loginOpening ? \'opening\' : \'\'}}"'));
  ...
  assert.ok(miniWxml.includes("{{enteringRopeId === slot.ropeId ? 'entering-rope' : ''}}"));
  ...
  assert.ok(miniCssBlockLast('.login-gate').includes('perspective: 1200rpx;'));
  ...
  assert.ok(miniCssBlockLast('.login-cabinet-frame').includes('transform-origin: 50% 58%;'));
  ...
  assert.ok(miniWxss.includes('.image-login-gate.opening .login-cabinet-frame'));
  assert.ok(miniWxss.includes('@keyframes loginCabinetPushOpen'));
  assert.ok(miniWxss.includes('@keyframes loginGlowCollapse'));
  ...
  assert.ok(miniCssBlockLast('.rope-coil-couple').includes('width: 132rpx;'));
  ...
  assert.ok(miniWxss.includes('.rope-tile.entering-rope .rope-coil'));
  assert.ok(miniWxss.includes('@keyframes ropeTileEnterPull'));
  assert.ok(miniWxss.includes('@keyframes ropeNoteEnterPull'));
  ...
  assert.ok(miniWxml.includes('class="rope-coil rope-coil-{{slot.mode}}"'));
  assert.ok(miniWxml.includes('class="rope-coil-image"'));
  assert.ok(miniWxml.includes('rope-coil-{{slot.mode}}'));
  ...
  assert.ok(miniPage.includes('loginOpening: false'));
  ...
  assert.ok(miniAddWxml.includes('class="add-rope-rope add-rope-rope-{{addRopeMode}} progressive-reveal"'));
  assert.ok(miniAddWxml.includes('class="add-rope-tail-image add-rope-tail-red"'));
  ...
  assert.ok(miniAddCssBlock('.add-rope-rope').includes('width: 136rpx'));
  assert.ok(miniAddCssBlock('.add-rope-rope').includes('height: 440rpx'));
  assert.ok(miniAddCssBlock('.add-rope-rope').includes('margin: 18rpx auto 0'));
  assert.ok(miniAddCssBlock('.add-rope-rope').includes('position: relative'));
  assert.ok(miniAddCssBlock('.add-rope-tail-image').includes('width: 118rpx'));
  assert.ok(miniAddCssBlock('.add-rope-tail-image').includes('height: 440rpx'));
  ...
  assert.ok(miniAddCssBlock('.add-rope-tail-image').includes('transform: translateX(-50%) scaleX(1.22)'));
  assert.ok(miniAddCssBlock('.add-rope-rope-couple').includes('width: 188rpx'));
  assert.ok(miniAddCssBlock('.add-rope-rope-couple .add-rope-tail-red').includes('hue-rotate(-18deg)'));
