...
test('mini add-rope layout follows the static index reference positions', () => {
  ...
  assert.ok(!miniWxml.includes('add-rope-back-char'));
  ...
  assert.ok(backButton.includes('top: 80rpx'));
  assert.ok(backButton.includes('left: -18rpx'));
  assert.ok(backButton.includes('display: grid'));
  assert.ok(backButton.includes('place-items: center'));
  assert.ok(backButton.includes('width: 112rpx'));
  assert.ok(backButton.includes('height: 92rpx'));
  assert.ok(backButton.includes('min-width: 112rpx'));
  assert.ok(backButton.includes('min-height: 92rpx'));
  assert.ok(backButton.includes('padding: 22rpx 24rpx 20rpx 28rpx'));
  ...
  assert.ok(!backButton.includes('height: 112rpx'));
  assert.ok(backTape.includes('top: -14rpx'));
  assert.ok(backTape.includes('left: 26rpx'));
  assert.ok(backTape.includes('width: 64rpx'));
  assert.ok(backTape.includes('height: 24rpx'));
  assert.ok(backTape.includes('transform: rotate(-7deg)'));
  assert.ok(cssBlockLast('.add-rope-back-label').includes('display: block'));
  assert.ok(cssBlockLast('.add-rope-back-label').includes('white-space: nowrap'));
  assert.ok(cssBlockLast('.add-rope-back-label').includes('font-size: 30rpx'));
